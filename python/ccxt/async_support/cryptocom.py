...
class cryptocom(Exchange):
    ...
    async def fetch_markets(self, params={}):
        ...
        #     }
        #  }
        response = await self.publicGetPublicGetInstruments(params)
    ...
    async def fetch_tickers(self, symbols=None, params={}):
        ...
        response = await self.publicGetPublicGetTicker(params)
        # {
        #     "code":0,
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        response = await self.publicGetPublicGetTicker(self.extend(request, params))
        # {
        #     "code":0,
        #     "method":"public/get-ticker",
        #     "result":{
    ...
    async def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = await self.publicGetPublicGetTrades(self.extend(request, params))
        # {
        #     "code":0,
    ...
    async def fetch_balance(self, params={}):
        await self.load_markets()
        response = await self.privatePostPrivateGetAccountSummary(params)
        # {
        #     "id": 11,
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        ...
        response = await self.privatePostPrivateGetOrderDetail(self.extend(request, params))
        # {
        #     "id": 11,
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        response = await self.privatePostPrivateCreateOrder(self.extend(request, params))
        # {
        #     "id": 11,
        ...
        order = await self.fetch_order(value, symbol)
        return order
    ...
    async def cancel_all_orders(self, symbol=None, params={}):
        ...
        response = await self.privatePostPrivateCancelAllOrders(self.extend(request, params))
        return response
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        order = await self.fetch_order(id, symbol)
        return order
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = await self.privatePostPrivateGetTrades(self.extend(request, params))
        # {
        #     "id": 11,
    ...
    async def fetch_deposit_address(self, code, params={}):
        ...
        response = await self.privatePostPrivateGetDepositAddress(self.extend(request, params))
        # {
        #     "id": 11,
    ...
    async def fetch_deposits(self, code=None, since=None, limit=None, params={}):
        ...
        response = await self.privatePostPrivateGetDepositHistory(self.extend(request, params))
        # {
        #     "id": 11,
